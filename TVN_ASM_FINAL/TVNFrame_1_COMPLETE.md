# TVNFrame_1 - Complete Assembly Extraction

**Vtable Address**: 0x00435B50
**Binary**: europeo.exe
...
```assembly
0042d471  45                        inc      ebp
0042d472  c0 74 00 83 45            sal      byte ptr [eax + eax - 0x7d], 0x45
0042d477  cc                        int3     
0042d478  02 83 45 cc 03 8d         add      al, byte ptr [ebx - 0x72fc33bb]
0042d47e  55                        push     ebp
0042d47f  e0 52                     loopne   0x42d4d3
...
0042da9c  5d                        pop      ebp
0042da9d  c3                        ret      
0042da9e  55                        push     ebp
0042da9f  8b ec                     mov      ebp, esp
0042daa1  83 c4 cc                  add      esp, -0x34
0042daa4  53                        push     ebx
0042daa5  8b 5d 08                  mov      ebx, dword ptr [ebp + 8]
0042daa8  b8 34 ae 44 00            mov      eax, 0x44ae34
0042daad  e8 66 51 fd ff            call     0x402c18
0042dab2  80 bb a8 01 00 00 00      cmp      byte ptr [ebx + 0x1a8], 0
0042dab9  0f 85 73 01 00 00         jne      0x42dc32
0042dabf  c6 83 a8 01 00 00 01      mov      byte ptr [ebx + 0x1a8], 1
0042dac6  ff 73 0c                  push     dword ptr [ebx + 0xc]
0042dac9  e8 36 ad 00 00            call     0x438804
0042dace  85 c0                     test     eax, eax
0042dad0  0f 95 c2                  setne    dl
0042dad3  83 e2 01                  and      edx, 1
0042dad6  84 d2                     test     dl, dl
0042dad8  0f 84 47 01 00 00         je       0x42dc25
0042dade  53                        push     ebx
0042dadf  e8 02 fe ff ff            call     0x42d8e6
0042dae4  59                        pop      ecx
0042dae5  53                        push     ebx
0042dae6  e8 8e fe ff ff            call     0x42d979
0042daeb  59                        pop      ecx
0042daec  83 7b 0c 00               cmp      dword ptr [ebx + 0xc], 0
0042daf0  75 79                     jne      0x42db6b
0042daf2  8d 4d cc                  lea      ecx, [ebp - 0x34]
0042daf5  51                        push     ecx
0042daf6  6a 00                     push     0
0042daf8  6a 00                     push     0
0042dafa  6a 00                     push     0
0042dafc  6a 01                     push     1
0042dafe  68 e0 3b 40 00            push     0x403be0
0042db03  6a 00                     push     0
0042db05  68 be 06 00 00            push     0x6be
0042db0a  68 d0 c5 44 00            push     0x44c5d0
0042db0f  68 c4 c5 44 00            push     0x44c5c4
0042db14  68 ec c5 44 00            push     0x44c5ec
0042db19  8d 45 fc                  lea      eax, [ebp - 4]
0042db1c  50                        push     eax
0042db1d  e8 ee a9 00 00            call     0x438510
0042db22  83 c4 14                  add      esp, 0x14
0042db25  8d 55 fc                  lea      edx, [ebp - 4]
0042db28  52                        push     edx
0042db29  ff 45 e8                  inc      dword ptr [ebp - 0x18]
0042db2c  8d 4d f8                  lea      ecx, [ebp - 8]
0042db2f  51                        push     ecx
0042db30  e8 af a8 00 00            call     0x4383e4
0042db35  83 c4 08                  add      esp, 8
0042db38  ff 45 e8                  inc      dword ptr [ebp - 0x18]
0042db3b  66 c7 45 dc 0c 00         mov      word ptr [ebp - 0x24], 0xc
0042db41  ff 4d e8                  dec      dword ptr [ebp - 0x18]
0042db44  6a 02                     push     2
0042db46  8d 45 fc                  lea      eax, [ebp - 4]
0042db49  50                        push     eax
0042db4a  e8 15 aa 00 00            call     0x438564
0042db4f  83 c4 08                  add      esp, 8
0042db52  83 45 e8 02               add      dword ptr [ebp - 0x18], 2
0042db56  83 45 e8 03               add      dword ptr [ebp - 0x18], 3
0042db5a  8d 55 f8                  lea      edx, [ebp - 8]
0042db5d  52                        push     edx
0042db5e  68 88 3b 40 00            push     0x403b88
0042db63  e8 42 a9 00 00            call     0x4384aa
0042db68  83 c4 24                  add      esp, 0x24
0042db6b  ff 73 0c                  push     dword ptr [ebx + 0xc]
0042db6e  e8 8b ac 00 00            call     0x4387fe
0042db73  85 c0                     test     eax, eax
0042db75  0f 95 c1                  setne    cl
0042db78  83 e1 01                  and      ecx, 1
0042db7b  84 c9                     test     cl, cl
0042db7d  0f 85 a2 00 00 00         jne      0x42dc25
0042db83  53                        push     ebx
0042db84  e8 7e 4b 00 00            call     0x432707
0042db89  59                        pop      ecx
0042db8a  83 7b 0c 00               cmp      dword ptr [ebx + 0xc], 0
0042db8e  0f 85 85 00 00 00         jne      0x42dc19
0042db94  8d 45 cc                  lea      eax, [ebp - 0x34]
0042db97  50                        push     eax
0042db98  6a 00                     push     0
0042db9a  6a 00                     push     0
0042db9c  6a 00                     push     0
0042db9e  6a 01                     push     1
0042dba0  68 e0 3b 40 00            push     0x403be0
0042dba5  6a 00                     push     0
0042dba7  66 c7 45 dc 18 00         mov      word ptr [ebp - 0x24], 0x18
0042dbad  68 69 07 00 00            push     0x769
0042dbb2  68 05 c6 44 00            push     0x44c605
0042dbb7  68 f9 c5 44 00            push     0x44c5f9
0042dbbc  68 21 c6 44 00            push     0x44c621
0042dbc1  8d 55 f4                  lea      edx, [ebp - 0xc]
0042dbc4  52                        push     edx
0042dbc5  e8 46 a9 00 00            call     0x438510
0042dbca  83 c4 14                  add      esp, 0x14
0042dbcd  8d 4d f4                  lea      ecx, [ebp - 0xc]
0042dbd0  51                        push     ecx
0042dbd1  ff 45 e8                  inc      dword ptr [ebp - 0x18]
0042dbd4  8d 45 f0                  lea      eax, [ebp - 0x10]
0042dbd7  50                        push     eax
0042dbd8  e8 07 a8 00 00            call     0x4383e4
0042dbdd  83 c4 08                  add      esp, 8
0042dbe0  ff 45 e8                  inc      dword ptr [ebp - 0x18]
0042dbe3  66 c7 45 dc 24 00         mov      word ptr [ebp - 0x24], 0x24
0042dbe9  ff 4d e8                  dec      dword ptr [ebp - 0x18]
0042dbec  6a 02                     push     2
0042dbee  8d 55 f4                  lea      edx, [ebp - 0xc]
0042dbf1  52                        push     edx
0042dbf2  e8 6d a9 00 00            call     0x438564
0042dbf7  83 c4 08                  add      esp, 8
0042dbfa  66 c7 45 dc 18 00         mov      word ptr [ebp - 0x24], 0x18
0042dc00  83 45 e8 02               add      dword ptr [ebp - 0x18], 2
0042dc04  83 45 e8 03               add      dword ptr [ebp - 0x18], 3
0042dc08  8d 4d f0                  lea      ecx, [ebp - 0x10]
0042dc0b  51                        push     ecx
0042dc0c  68 88 3b 40 00            push     0x403b88
0042dc11  e8 94 a8 00 00            call     0x4384aa
0042dc16  83 c4 24                  add      esp, 0x24
0042dc19  6a 00                     push     0
0042dc1b  6a 00                     push     0
0042dc1d  ff 73 0c                  push     dword ptr [ebx + 0xc]
0042dc20  e8 cd ab 00 00            call     0x4387f2
0042dc25  8b 43 68                  mov      eax, dword ptr [ebx + 0x68]
0042dc28  83 c0 19                  add      eax, 0x19
0042dc2b  50                        push     eax
0042dc2c  e8 53 aa 00 00            call     0x438684
0042dc31  59                        pop      ecx
0042dc32  8b 55 cc                  mov      edx, dword ptr [ebp - 0x34]
0042dc35  64 89 15 00 00 00 00      mov      dword ptr fs:[0], edx
0042dc3c  5b                        pop      ebx
0042dc3d  8b e5                     mov      esp, ebp
0042dc3f  5d                        pop      ebp
0042dc40  c3                        ret      
```
